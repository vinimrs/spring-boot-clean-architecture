...
@Table(name = "Usuario")
public abstract class UsuarioSchema extends AbstractEntitySchema<Long> {
...
//    @Name(message = "{Name.user.name}")
    ...
    public UsuarioSchema(String username, String password, String name, String email) {
    ...
    public UsuarioSchema(Long id, String username, String name, String email, String password) {
        this.setId(id);
        this.name = name;
        this.email = email;
        this.password = password;
